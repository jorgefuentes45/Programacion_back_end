...
const Recetas = () => {
    ...
    const PeticionPut = async () => {
        await axios.put('http://localhost:3001/recetas/'+recetaseleccionada.id, recetaseleccionada)
          .then(response => {
            var dataNueva = data;
      ...
      const PeticionDelete = async () => {
        await axios.delete('http://localhost:3001/recetas/'+recetaseleccionada.id)
          .then(response => {
      ...
      const PeticionPost = async () => {
        ...
        recetaseleccionada.id = nueva_id;
          await axios.post('http://localhost:3001/recetas', recetaseleccionada)
            .then(response => {
  ...
  return (
    <div>
        ...
        <Button onClick={()=>(abrirCerrarModalInsertar())}>Añadir receta</Button>
        <Row gutter={16}>
